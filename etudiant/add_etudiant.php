            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <div class="card-title">Ajout d'Etudiant</div>
                </div>
                <div class="card-body">
                  <div class="row">
                    <form action="validation_add_etudiant.php" method="post" enctype="multipart/form-data">
                      <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-group-default">
                                  <label>Adresse</label>
                                  <input id="addType" type="text" name="adresse" class="form-control" placeholder="Entrez l'adresse" required />
                                </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-group-default">
                                  ...
                                  <input id="addLieu" type="text" name="telephone" class="form-control" placeholder="Entrez le contact" required />
                                </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-group-default">
                                  <label>Classe</label>
                                  <input id="addLieu" type="text" name="classe" class="form-control" placeholder="Entrez la classe" required />
                                </div>
                              </div>                     
